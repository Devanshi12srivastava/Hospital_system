  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <form onSubmit={onSubmitHandler} className="w-full max-w-5xl mx-auto">
        <p className="font-semibold text-2xl mb-5 text-gray-700">Add Doctor</p>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-md border max-h-[85vh] overflow-y-auto">
          ...
          <button
            type="submit"
            className="mt-6 w-full bg-blue-500 hover:bg-blue-600 text-white py-3 rounded-xl font-medium transition cursor-pointer"
          >
            Add Doctor
          </button>
        </div>
